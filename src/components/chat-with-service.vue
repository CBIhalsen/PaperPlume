...
<!--            <i class="fa-solid fa-angles-down"></i> fa-solid fa-angles-up-->
            <i class="fa-solid fa-angles-down" @click="windowdown" id="fa-angles-down" style="color: #9bb6e4;cursor: pointer;"></i>
            <i class="fa-solid fa-angles-up" @click="windowup" id="fa-angles-up" style="color: #9bb6e4; display: none;cursor: pointer"></i>
        </div>
